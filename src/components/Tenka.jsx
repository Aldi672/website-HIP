  ...
  return (
    <div id="tentangkami" className="w-full flex items-center justify-center bg-cover bg-center">
      <main
        ...
        className="flex-grow text-black p-10 flex h-[100vh] justify-center items-center"
      ...
      >
        ...
        {/* Kolom Kanan */}
        <div id="body" className="w-1/2" data-aos="fade-right"> {/* Animasi ketika masuk dari kanan */}
          <h1 id="intro" className="text-5xl font-bold mb-[2rem]">INTRODUCTION</h1>
          <div id="bar" className="w-56 h-1 bg-yellow-500 mb-[2rem]"></div>
          <p className="mb-4">
